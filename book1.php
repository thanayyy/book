...
<?php
        ...
        $sql = "select BookId, BookName, TypeName, StatusName, Publish, UnitPrice, UnitRent, DayAmount, picture, BookDate from book inner join typebook on book.TypeID=typebook.TypeID inner join statusbook on book.StatusID=statusbook.statusId WHERE DayAmount > 5;";
